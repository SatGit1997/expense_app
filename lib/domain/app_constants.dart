...
class AppConstants{
  ...
  static  List<CatModel> mCat = [
    ...
    CatModel(id: (6), title: "Transfer", imgPath: "assets/icons/mobile-transfer.png"),
    CatModel(id: (7), title: "Music", imgPath: "assets/icons/music.png"),
    ...
    CatModel(id: (11), title: "Watch", imgPath: "assets/icons/watch.png"),
    CatModel(id: (11), title: "Tools", imgPath: "assets/icons/tools.png"),
    CatModel(id: (11), title: "PopCorn", imgPath: "assets/icons/popcorn.png"),
    CatModel(id: (11), title: "Hotpot", imgPath: "assets/icons/hot-pot.png"),
    CatModel(id: (11), title: "Vegetable", imgPath: "assets/icons/vegetables.png"),
  ];
}